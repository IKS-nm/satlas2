...
datasource = satlas2.Source(
    data_x, data_y, yerr=modifiedSqrt, name="ArtificialData1"
)
...
f.setExpr(
    "ArtificialData1___Signal___FWHML", "ArtificialData1___Signal___FWHMG"
)
